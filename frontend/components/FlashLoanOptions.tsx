  ...
  return (
    <div className="rounded-xl bg-gradient-to-b from-slate-800/80 to-slate-900/80 backdrop-blur-lg p-4 shadow-xl border border-white/10">
      <h2 className="text-xl font-semibold text-white mb-4 flex items-center">
        <div className="w-8 h-8 mr-2 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-full flex items-center justify-center">
      ...
      {Object.values(reserves).some(reserve =>
        ...
        <div className="mb-4 p-3 bg-blue-600/10 border border-blue-500/30 rounded-xl text-blue-300 text-sm">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white/5 p-3 rounded-xl border border-white/10">
          <div className="flex justify-between mb-2">
            <label htmlFor="loan-amount" className="block text-white/80 text-sm font-medium flex items-center">
              <div className="w-2 h-2 rounded-full bg-gradient-to-r from-purple-400 to-purple-600 mr-2"></div>
              Loan Amount
            </label>
            <button
              onClick={() => {
          ...
          <div className="relative">
            <input
              ...
              placeholder="0.0"
              className="w-full p-3 bg-white/5 border border-white/20 rounded-lg text-white text-lg focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500 transition-all"
              aria-label={`Enter ${selectedToken.symbol} amount`}
            />
            <div className="absolute top-1/2 transform -translate-y-1/2 right-3 text-white/70 text-base font-medium">
              {selectedToken.symbol}
            </div>
          </div>
          {reserve && !loadingReserves && (
            <p className="text-white/60 text-xs mt-2 flex items-center">
              <svg className="w-3 h-3 mr-1 text-cyan-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor" strokeWidth="1.5" />
        ...
        {(error || errorReserves || errorFees) && (
          <div className="p-3 bg-red-900/20 border border-red-600/30 rounded-xl text-red-300 text-sm">
            <div className="flex justify-between items-center">
              ...
              <button
                onClick={reload}
                className="ml-2 flex-shrink-0 bg-white/10 hover:bg-white/20 text-cyan-300 rounded-full p-1.5 transition-colors"
        ...
        {(loadingReserves || loadingFees) && (
          <div className="flex items-center justify-center py-4 text-cyan-300 text-sm bg-white/5 rounded-xl border border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-gradient-to-br from-slate-800/60 to-slate-900/60 border border-white/10 rounded-xl text-sm">
              <h3 className="text-white font-medium mb-3 flex items-center">
                <svg className="w-4 h-4 mr-2 text-cyan-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor" strokeWidth="1.5" />
              ...
              <div className="grid grid-cols-1 gap-2 text-white/70">
                ...
                <div className="flex justify-between items-center p-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                  ...
                  <span className={`${getStatusStyle(reserve)} px-2 py-1 rounded-md text-xs font-semibold`}>
              ...
              <div className="space-y-2 text-white/70">
                <div className="flex justify-between items-center p-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                  ...
                  {loadingFees ? (
                    ...
                    <span className="font-medium text-white text-base">{`${flashLoanFees?.totalPercent}%`}</span>
                  )}
                </div>
                <div className="grid grid-cols-1 gap-1.5 pl-4 mt-1">
                  <div className="flex justify-between items-center p-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
        ...
        <button
          ...
          className={`w-full py-3 rounded-xl text-base font-medium transition-all duration-200 relative overflow-hidden group ${
            !isConnected ||
            !isCorrectNetwork ||
            !loanAmount ||
            isLoading ||
        ...
        {/* Status Messages */}
        {!isConnected && (
          <div className="flex items-center justify-center p-3 bg-amber-500/10 border border-amber-500/30 rounded-xl text-amber-400 text-sm">
