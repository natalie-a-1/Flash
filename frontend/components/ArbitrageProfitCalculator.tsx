    ...
    <div className="p-2.5 bg-gradient-to-br from-slate-800/60 to-slate-900/60 border border-white/10 rounded-lg text-xs">
      <div className="flex justify-between items-center mb-2.5">
        <h3 className="text-sm font-medium text-white flex items-center">
          <div className="w-5 h-5 mr-1.5 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-full flex items-center justify-center">
            <svg
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-2.5">
        ...
        <div className="md:col-span-5 space-y-2">
          ...
          <div className="bg-white/5 p-2 rounded-lg border border-white/10">
            <label className="text-white/80 text-[10px] font-medium mb-1 flex items-center">
              <div className="w-1 h-1 rounded-full bg-gradient-to-r from-purple-400 to-purple-600 mr-1.5"></div>
              Slippage Tolerance
              <div className="ml-1 group relative">
                <svg
                  className="w-3 h-3 text-white/40 hover:text-white/70 transition-colors"
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <div className="absolute left-0 bottom-full mb-2 w-48 rounded-md bg-gray-900 text-white text-[10px] p-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10 shadow-lg border border-white/10">
                  ...
                  Slippage tolerance accounts for price movements during
                  transaction confirmation. Higher values ensure execution but
            ...
            <div className="relative">
              <input
                ...
                placeholder="0.5"
                className="w-full p-1.5 bg-white/5 border border-white/20 rounded text-white text-xs focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500 transition-all"
              />
              <div className="absolute top-1/2 transform -translate-y-1/2 right-3 text-white/70 text-xs">
                %
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 p-2 rounded-lg border border-white/10">
            <label className="text-white/80 text-[10px] font-medium mb-1 flex items-center">
              <div className="w-1 h-1 rounded-full bg-gradient-to-r from-cyan-400 to-cyan-600 mr-1.5"></div>
              Profit Threshold
              <div className="ml-1 group relative">
                <svg
                  className="w-3 h-3 text-white/40 hover:text-white/70 transition-colors"
                ...
                <div className="absolute left-0 bottom-full mb-2 w-48 rounded-md bg-gray-900 text-white text-[10px] p-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10 shadow-lg border border-white/10">
                  <div className="absolute left-0 bottom-[-6px] transform translate-x-1 rotate-45 w-3 h-3 bg-gray-900 border-r border-b border-white/10"></div>
                  Minimum profit (in USD) required for an arbitrage opportunity
                  to be considered profitable. Higher thresholds ensure you only
                  execute trades with significant profit.
                </div>
              </div>
            </label>
            <div className="relative">
              <input
                ...
                placeholder="10"
                className="w-full p-1.5 bg-white/5 border border-white/20 rounded text-white text-xs focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500 transition-all"
              />
              <div className="absolute top-1/2 transform -translate-y-1/2 right-3 text-white/70 text-xs">
                USD
              </div>
        ...
        <div className="md:col-span-7">
          ...
          >
            <div className="text-center mb-2">
              <h4 className="text-xs font-medium">Estimated Profit</h4>
            ...
            <div className="space-y-1.5 border-t border-white/20 pt-2 text-[10px]">
              {/* Best Arbitrage Path */}
                ...
                <div className="flex justify-between items-center p-1.5 rounded bg-white/5">
                  <div className="flex items-center">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M7.5 13.5L10.5 16.5L13.5 13.5"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      ...
                      />
                      <path
                        d="M16.5 10.5L13.5 7.5L10.5 10.5"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
