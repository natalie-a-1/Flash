          ...
          <div className="bg-white/5 p-2 rounded-lg border border-white/10">
            <label className="text-white/80 text-[10px] font-medium mb-1 flex items-center">
              ...
              <div className="ml-1 group relative">
                <svg className="w-3 h-3 text-white/40 hover:text-white/70 transition-colors" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="space-y-1.5 border-t border-white/20 pt-2 text-[10px]">
              ...
              {buyExchange && sellExchange && (
                <div className="grid grid-cols-1 gap-1.5">
                  ...
                  <div className="flex justify-between items-center p-1.5 rounded bg-white/5">
                    <div className="flex items-center">
                      <svg className="w-2.5 h-2.5 mr-1 text-purple-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M8.5 12H15.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
