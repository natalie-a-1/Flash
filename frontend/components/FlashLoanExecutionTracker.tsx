            ...
            <div className="space-y-2">
              {steps.map((step, index) => (
                <div key={step.id || index} className="relative pl-7">
                  {/* Status dot */}
                  <div
                    className={`absolute left-0 top-0 mt-1.5 w-7 h-7 rounded-full border flex items-center justify-center ${getStatusStyles(step.status)}`}
                  >
                  ...
                  {/* Step content */}
                  <div
                    className={`p-2 rounded-lg ${getStatusStyles(step.status)}`}
                  >
