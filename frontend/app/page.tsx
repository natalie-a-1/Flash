  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm">
        <h1 className="text-4xl font-bold mb-8 text-center">Flash Blockchain Project</h1>
        
        <div className="bg-white/30 p-8 rounded-lg shadow-xl max-w-2xl mx-auto">
          <h2 className="text-2xl font-semibold mb-4">Ethereum Connection Status</h2>
          ...
          {isConnected && !isCorrectNetwork && (
            <div className="mt-4">
              ...
              <p className="text-sm mt-1">
                Sepolia is an Ethereum testnet used for development. You can experiment without using real ETH.
              </p>
            </div>
          )}
          ...
          {isConnected && isCorrectNetwork && (
            <div className="mt-6">
              ...
              <p className="text-sm mb-2">Need test ETH? Get some from these faucets:</p>
